...
# Gráfica de la entrada sinusoidal
plt.plot(t, u1, '-', color=[0.9, 0.1, 0.7], label='$Pao(t)$')  # Entrada sinusoidal (u1).

# Respuesta del sistema NORMAL (primer caso)
ts, Pp1 = control.forced_response(sys1, t, u1, x0)  # Calcula la respuesta.
plt.plot(t, Pp1, '-', color=[0, 0.25, 0.4], label='$P_p(t)$: Control')  # Gráfica de la respuesta.
